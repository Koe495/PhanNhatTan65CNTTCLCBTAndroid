package com.example.onlinemoneyvaluetransfer;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button1.setOnClickListener(v -> {
            ...
            if (rates.isEmpty()) {
                Toast.makeText(MainActivity.this, "Đang tải dữ liệu tỷ giá, vui lòng thử lại!", Toast.LENGTH_SHORT).show();
                return;
            }
    ...
    private class FetchRatesTask extends AsyncTask<Void, Void, HashMap<String, Float>> {
        ...
        protected void onPostExecute(HashMap<String, Float> fetchedRates) {
            if (!fetchedRates.isEmpty()) {
                ...
                Toast.makeText(MainActivity.this, "Không thể tải tỷ giá!", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
