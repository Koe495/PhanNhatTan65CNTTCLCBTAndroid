package com.example.nhtuapp; // Thay bằng package của bạn
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.btnChucNang2) {
            ...
            startActivity(new Intent(MainActivity.this, TinhDiemActivity.class));
        } else if (v.getId() == R.id.btnChucNang3) {
            // Mở màn hình Danh Sách Môn
            startActivity(new Intent(MainActivity.this, DanhSachMonActivity.class));
        } else if (v.getId() == R.id.btnChucNang4) {
            // Mở màn hình Hoạt Động
            startActivity(new Intent(MainActivity.this, HoatDongActivity.class));
        } else if (v.getId() == R.id.btnAboutMe) {
            // Mở màn hình About Me
